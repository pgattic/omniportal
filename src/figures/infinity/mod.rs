...
pub const INFINITY_CATALOG: &[FigureCatalogEntry] = &[
    ...
    entry!(
        ...
        Character,
        "Fantasia",
        "Sorcerer's Apprentice Mickey (Crystal)",
        0x0f4265
    ),
    entry!(
        37,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "Bolt - Bolt's Super Strength - Ability",
        0x2dc6c3
    ),
    entry!(
        43,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "Fantasia - Chernabog's Power - Ability",
        0x2dc6c5
    ),
    entry!(
        45,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "Frankenweenie - Electro-Charge - Ability",
        0x2dc6c8
    ),
    entry!(
        48,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "Tangled - Rapunzel's Healing - Ability",
        0x2dc6ca
    ),
    entry!(
        50,
        PowerDisc,
        "Power Disc",
        "Cars - C.H.R.O.M.E. Armor Shield - Ability",
        0x2dc6cb
    ),
    entry!(
        51,
        PowerDisc,
        "Power Disc",
        "Toy Story - Star Command Shield - Ability",
        0x2dc6cc
    ),
    entry!(
        52,
        PowerDisc,
        "Power Disc",
        "The Incredibles - Violet's Force Field - Ability",
        0x2dc6cd
    ),
    entry!(
        53,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "DuckTales - Scrooge McDuck's Lucky Dime - Ability",
        0x2dc6cf
    ),
    entry!(
        55,
        PowerDisc,
        "Power Disc",
        "TRON - User Control Disc - Ability",
        0x2dc6d0
    ),
    entry!(
        56,
        PowerDisc,
        "Power Disc",
        "Fantasia - Mickey's Sorcerer Hat - Ability",
        0x2dc6d1
    ),
    entry!(
        57,
        PowerDisc,
        "Power Disc",
        "Toy Story - Emperor Zurg's Wrath - Ability",
        0x2dc6fe
    ),
    entry!(
        58,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "Bolt - Calico Helicopter - Toy (Aircraft)",
        0x3d091c
    ),
    entry!(
        69,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "Aladdin - Abu the Elephant - Toy (Mount)",
        0x3d091f
    ),
    entry!(
        72,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "Beauty and the Beast - Phillipe - Toy (Mount)",
        0x3d0921
    ),
    entry!(
        74,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "Mulan - Dragon Firework Cannon - Toy (Weapon)",
        0x3d0924
    ),
    entry!(
        77,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "Up - Carl Fredricksen's Cane - Toy (Weapon)",
        0x3d0928
    ),
    entry!(
        81,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "Condorman - Condorman Glider - Toy (Glider)",
        0x3d092a
    ),
    entry!(
        83,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "TRON - On the Grid - Customization (Terrain)",
        0x3d092c
    ),
    entry!(
        85,
    ...
    entry!(
        ...
        PowerDisc,
        "Power Disc",
        "Phineas and Ferb - Tri-State Area Terrain",
        0x3d0945
    ),
    entry!(
        103,
